...
def build_run_player(ndf,ldf, 
    ...
    sn1 = create_snapshot(
        ...
        description="<p>This is a network of the most archetypal people in each 'Creative Species' cluster.  \
                ...
                <b>Node Size:</b>  Cluster Centrality: Larger nodes are more representative or archetypal of the cluster</p>",
        layout_params={
            ...
            "settings": {
                ...
                "nodeColorAttr": "Creative Species", 
                "nodeColorPaletteOrdinal": [
                    #{"col": "#2aadbf"},
                    {"col": "#f06b51"}, # species 2 
                    {"col": "#2aadbf"}, # species 1 
                    {"col": "#fbb44d"},
                    {"col": "#cd4747"},
                    {"col": "#1a7480"},
                    {"col": "#8c55aa"},
                ...
                # labels
                "drawLabels": False,  # show node labels
                "drawGroupLabels": True, # show cluster labels
            },
        },
    )
    ...
    create_map(
        ...
        playerSettings={
            ...
            "headerTitle": "Creative Species Archetypes",
            "modalTitle": "Creative Species Archetypes",
            "headerImageUrl": "",
            "modalSubtitle": "<p>This is a network of the most archetypal people in each 'Creative Species' cluster.  \
                            Each node is a survey respondent, and they are linked if they share similar sets of 'Creative Habits'. \
                            The colored clusters are emergent 'Creative Species' defined as groups of people with similar combinations of Creative Habits. \
                            The clusters are labeled by the most commonly shared and defining Creative Habits of the cluster. \
                            </p>\
